	<h1>Slideshows</h1>
			...
			<p>PS! The slides can be rearranged via drag and drop in the order that you want</p>
			
			<hr>
			
			<h3>2: Inserting slideshows on pages</h3>
			<p>You can insert your slider in two ways; via a shortcode or with the Slider widget.
